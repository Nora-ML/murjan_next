...
const UpdatePage = styled.div.attrs((props) => ({ location: props.location }))`
        ...
        @keyframes updateCircle {
            0%{clip-path: ${(props) =>
							props.location};background-color:var(--main_color);}
        ...
        @keyframes updateCloseCircle {
            0%{clip-path: circle(120.5% at 86% 16%);background-color:var(--counter_light);display:flex;}
...
export { AddPageStyle, UpdatePage, FormAndHeaderWrap };
